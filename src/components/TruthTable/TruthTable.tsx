...
import { TrainerType, XNode, Result, Trainer } from '../../interfaces&types&consts/types';
import styles from './TruthTable.module.scss';
import { useEffect, useState } from 'react';
import { X, operators, answers, BooleanValuesOrder, CarnoValuesOrder } from '../../interfaces&types&consts/consts';
  ...
  function checkAnswer() {
    if (result >= 0) {
      ...
      if (type == 'static') {
        ...
        const check = CheckTreeAnswer(tree._root, tableFilling, 
          (trainer === 'Carno' ? CarnoValuesOrder : BooleanValuesOrder)[vars]);
        count = check.count;
